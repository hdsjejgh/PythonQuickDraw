...
class QuickDrawApp:
    def __init__(self,time=20):
        ...
        self.currentWord = tk.Label(self.mainframe, text="PLACEHOLDER", anchor="center", font=("Ink Free", 18), bg="#FFD139")
        ...
        self.submit = tk.Button(self.mainframe, text="Submit",font=("Ink Free",12),width=10,bg="#FFD139",relief='solid',command=self.__submit)
        self.submit.place(relx=0.1,rely=0.75)

        self.clear = tk.Button(self.mainframe, text="X", font=("Ink Free", 14), width=1, bg="#FFD139",relief='solid', command=self.__clear)
